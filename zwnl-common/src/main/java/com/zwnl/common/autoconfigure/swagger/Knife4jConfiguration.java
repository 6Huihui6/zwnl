package com.zwnl.common.autoconfigure.swagger;

import cn.hutool.core.convert.ConverterRegistry;
import com.fasterxml.classmate.TypeResolver;

import com.zwnl.common.domain.R;
import com.zwnl.common.utils.TjTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "zwnl.swagger", name = "enable",havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "zwnl.swagger", name = "enableResponseWrap",havingValue = "true")
